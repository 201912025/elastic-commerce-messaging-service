...
public class NotificationService {
    ...
    private final SlackService slackService;         // WebFlux 비동기 알림
    private final SlackSyncService slackSyncService;  // 동기 Slack 클라이언트
...
/*
try {
            slackSyncService.sendMessage(slackMessage);
        } catch (Exception e) {
            log.error("Slack 동기 알림 전송 실패", e);
        }
 */
